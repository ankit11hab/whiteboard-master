...
const StudentUserDetails = () => {
	...
	return (
		<div>
			<StudentLeftSideBar appBarHeading={`Personal Details`} />
			<main>
				{loading ? (
					<CircularProgress />
				) : currentUserData ? (
								...
								<TableBody>
									...
									{currentUserData &&
										(currentUserData.userRole === "admin" ||
											currentUserData.userRole === "subadmin" ||
											currentUserData.userRole === "tutor") && (
											<StyledTableRow>
												<StyledTableCell
													component="th"
													scope="row"
									...
									<StyledTableRow>
										...
										<StyledTableCell align="center">
											{currentUserData.userRole || "Not Provided"}
										</StyledTableCell>
									</StyledTableRow>
									{/* )} */}
									{userData && userData.uid === userId && (
