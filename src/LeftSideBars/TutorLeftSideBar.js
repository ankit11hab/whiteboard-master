...
function TutorLeftSideBar(props) {
	const { window } = props;
	...
	useEffect(() => {
		if (!userData) {
			...
			history.push("/");
		} else if (userData && userData.userRole && userData.userRole !== "tutor") {
			history.push("/");
		}
	}, [userData, history]);
		...
		<div>
			<div className={classes.toolbar}>
				<h3
					...
					onClick={() => history.push("/tutor/home")}
				>
					Tutor Controls
				</h3>
				<Divider />
			...
			>
				<ListItem button onClick={() => history.push("/tutor/home")}>
...
export default TutorLeftSideBar;
